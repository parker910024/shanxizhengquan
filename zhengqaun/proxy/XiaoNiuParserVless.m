...
static bool __global_direct_enable__ = NO;

@implementation XiaoNiuParserVless
+ (void)setGlobalDirectEnable:(BOOL)enable {
    __global_direct_enable__ = enable;
}
...
//vless://18fbec6c-7ad5-49ff-aedd-da4d8af85eb6@161.202.3.131:32966/?type=kcp&security=none&headerType=none&seed=RUXdF0Zfha#%E6%96%B0%E5%8A%A0%E5%9D%A1-vless-kcp
    ...
    configuration[@"stats"] = @{};
    configuration[@"policy"] = [XiaoNiuParser GetStatsPolicy];
