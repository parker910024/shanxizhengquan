//
//  ModifyPaymentPasswordViewController.swift
//  zhengqaun
//
...
class ModifyPaymentPasswordViewController: ZQViewController {
    ...
    private func setupInstruction() {
        instructionLabel.text = "请验证原支付密码"
    ...
    private func verifyPassword() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
            // 模拟验证成功
            let newPasswordVC = SetNewPaymentPasswordViewController()
            newPasswordVC.hidesBottomBarWhenPushed = true
