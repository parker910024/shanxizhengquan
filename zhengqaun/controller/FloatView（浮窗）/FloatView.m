...
- (void)addSubFloatViewWithColor:(UIColor *)color url:(NSString*)url title:(NSString *)title titleColor:(UIColor *)titleColor tag:(NSInteger)tag
{
    ...
    FloatViewSubView *subView = [FloatViewSubView floatViewSubViewWithFrame:subFrame url:url color:color title:title titleColor:(UIColor *)titleColor tag:tag];
...
- (void)addSubFloatViewWithImage:(UIImage *)image url:(NSString*)url title:(NSString *)title titleColor:(UIColor *)titleColor tag:(NSInteger)tag
{
    CGFloat cut = self.frame.size.width / 10;
    CGRect subFrame = CGRectMake(self.frame.origin.x + cut / 2, self.frame.origin.y + cut / 2, self.frame.size.width - cut, self.frame.size.height - cut);
    FloatViewSubView *subView = [FloatViewSubView floatViewSubViewWithFrame:subFrame url:url image:image title:title titleColor:(UIColor *)titleColor tag:tag];
    subView.delegate = self;
    [self.subFloatViews addObject:subView];
    [self.fatherView addSubview:subView];
    subView.hidden = YES;
